...
const Navbar = () => {
    return (
        <div className="bg-zinc-800/70 text-white shadow-sm px-8 py-5 flex justify-between items-center sticky top-0 left-0 backdrop-blur-xl flex-wrap lg:flex-nowrap z-30">
            <Link to="/">
